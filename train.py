...
def _main(agent_type: str, model_name: str, timesteps: int, n_frames: int, n_envs: int, setting: int) -> None:
    seed = 24
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", type=str, required=True, help="Name of the model to use for saving artifacts")
    ...
    _main(args.a, args.m, args.t, args.n_frames, args.n_envs, args.setting)
